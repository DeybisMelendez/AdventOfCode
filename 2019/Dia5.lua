...
3,3,1108,-1,8,3,4,3,99 --inmediato
}
local output = 0
...
local function intCode(i, iv)
    ...
    while true do
        ...
        elseif opCode == 5 then
            if not (input[param1] == 0) then pointer = input[param2] else pointer = pointer + 3 end
        elseif opCode == 6 then
            if input[param1] == 0 then pointer = input[param2] else pointer = pointer + 3 end
        elseif opCode == 7 then
            if input[param1] < input[param2] then input[param3] = 1 else input[param3] = 0 end
            pointer = pointer + 4
